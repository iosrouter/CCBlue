...
#import "CCBlueItemsController3.h"
...
@implementation CCBlueItemsController3
...
-(NSArray *)specifiers {
	...
	if (!_specifiers) {
        ...
        for (NSString *device in devices) {
            NSString *deviceSelected = [NSDictionary dictionaryWithContentsOfFile:CCBLUE_PREFS][@"selectedDevice3"];
