...
#import "CCBlueItemsController4.h"
...
@implementation CCBlueItemsController4
...
-(NSArray *)specifiers {
	...
	if (!_specifiers) {
        ...
        for (NSString *device in devices) {
            NSString *deviceSelected = [NSDictionary dictionaryWithContentsOfFile:CCBLUE_PREFS][@"selectedDevice4"];
