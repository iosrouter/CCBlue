...
#import "CCBlueItemsController2.h"
...
@implementation CCBlueItemsController2
...
-(NSArray *)specifiers {
	...
	if (!_specifiers) {
        ...
        for (NSString *device in devices) {
            NSString *deviceSelected = [NSDictionary dictionaryWithContentsOfFile:CCBLUE_PREFS][@"selectedDevice2"];
