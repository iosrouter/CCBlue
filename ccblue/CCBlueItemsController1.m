...
#import "CCBlueItemsController1.h"
...
@implementation CCBlueItemsController1
...
-(NSArray *)specifiers {
	...
	if (!_specifiers) {
        ...
        for (NSString *device in devices) {
            NSString *deviceSelected = [NSDictionary dictionaryWithContentsOfFile:CCBLUE_PREFS][@"selectedDevice1"];
