...
#import "CCBlueItemsController.h"
...
@implementation CCBlueItemsController
...
-(NSArray *)specifiers {
	...
	if (!_specifiers) {
        ...
        for (NSString *device in devices) {
            NSString *deviceSelected = [NSDictionary dictionaryWithContentsOfFile:CCBLUE_PREFS][@"selectedDevice"];
